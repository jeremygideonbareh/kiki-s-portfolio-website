      ...
      >
        ...
        <style jsx>{`
          ...
          .fx-header {
            ...
            font-size: clamp(1.4rem, 5vw, 4rem); line-height: 0.9; text-align: center; color: var(--fx-text);
          }
          ...
          .fx-footer-title { color: var(--fx-text); font-size: clamp(1.2rem, 4vw, 3rem); font-weight: 900; letter-spacing: -0.01em; line-height: 0.9; }
          .fx-progress { width: min(200px, 40vw); height: 2px; margin: 1rem auto 0; background: rgba(245,245,245,0.28); position: relative; }
          ...
          @media (max-width: 1100px) {
            ...
            .fx-center { order: 0; grid-column: 1 / -1; height: auto; }
            .fx-left { order: 1; height: auto; }
            .fx-right { order: 2; height: auto; }
          }
