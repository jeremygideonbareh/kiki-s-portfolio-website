...
function MemberRow({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        <span
          className={cn(
            ...
            isActive ? 'bg-[#f0e8dc] w-5' : 'bg-[#f0e8dc]/25',
          )}
        />
        <span
          className={cn(
            'text-base md:text-[18px] font-semibold leading-none tracking-tight transition-colors duration-300',
            isActive ? 'text-[#f0e8dc]' : 'text-[#f0e8dc]/80',
          )}
        >
          {member.name}
        </span>
          ...
          >
            {member.social?.twitter && (
              <a
                ...
                className="p-1 rounded text-[#f0e8dc]/50 hover:text-[#f0e8dc] hover:bg-[#f0e8dc]/10 transition-all duration-150 hover:scale-110"
                title="X / Twitter"
              >
                <FaTwitter size={10} />
              </a>
      ...
      <p className="mt-1.5 pl-[27px] text-[7px] md:text-[10px] font-medium uppercase tracking-[0.2em] text-[#f0e8dc]/50">
        {member.role}
      </p>
    </div>
  );
